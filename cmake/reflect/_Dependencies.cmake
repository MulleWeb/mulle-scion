...
if( NOT MULLE_SCION_LIBRARY)
   ...
   if( MULLE_SCION_LIBRARY)
      ...
      #
      # Append header directory to user search path.
      # Disable with: `mulle-sourcetree mark MulleScion no-cmake-searchpath`
      #
      foreach( _TMP_MULLE_SCION_NAME "MulleScion")
         set( _TMP_MULLE_SCION_DIR "${_TMP_MULLE_SCION_ROOT}/include/${_TMP_MULLE_SCION_NAME}")
         if( IS_DIRECTORY "${_TMP_MULLE_SCION_DIR}")
            set( INHERITED_INCLUDE_DIRS
               ${INHERITED_INCLUDE_DIRS}
               "${_TMP_MULLE_SCION_DIR}"
               CACHE INTERNAL "need to cache this"
            )
            break()
         else()
...
if( NOT MULLE_HOEDOWN_LIBRARY)
   ...
   if( MULLE_HOEDOWN_LIBRARY)
      ...
      #
      # Append header directory to user search path.
      # Disable with: `mulle-sourcetree mark MulleHoedown no-cmake-searchpath`
      #
      foreach( _TMP_MULLE_HOEDOWN_NAME "MulleHoedown")
         set( _TMP_MULLE_HOEDOWN_DIR "${_TMP_MULLE_HOEDOWN_ROOT}/include/${_TMP_MULLE_HOEDOWN_NAME}")
         if( IS_DIRECTORY "${_TMP_MULLE_HOEDOWN_DIR}")
            set( INHERITED_INCLUDE_DIRS
               ${INHERITED_INCLUDE_DIRS}
               "${_TMP_MULLE_HOEDOWN_DIR}"
               CACHE INTERNAL "need to cache this"
            )
            break()
         else()
...
if( NOT MULLE_WEB_SERVER_LIBRARY)
   ...
   if( MULLE_WEB_SERVER_LIBRARY)
      ...
      #
      # Append header directory to user search path.
      # Disable with: `mulle-sourcetree mark MulleWebServer no-cmake-searchpath`
      #
      foreach( _TMP_MULLE_WEB_SERVER_NAME "MulleWebServer")
         set( _TMP_MULLE_WEB_SERVER_DIR "${_TMP_MULLE_WEB_SERVER_ROOT}/include/${_TMP_MULLE_WEB_SERVER_NAME}")
         if( IS_DIRECTORY "${_TMP_MULLE_WEB_SERVER_DIR}")
            set( INHERITED_INCLUDE_DIRS
               ${INHERITED_INCLUDE_DIRS}
               "${_TMP_MULLE_WEB_SERVER_DIR}"
               CACHE INTERNAL "need to cache this"
            )
            break()
         else()
